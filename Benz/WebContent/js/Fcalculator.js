function changeProvince(){
	...
	provinceList['轿车']=['S级','E1级','C1级','A级'];
	provinceList['SUV']=['G级','GLS','GLE','GLC'];
	provinceList['轿跑车&敞篷跑车']=['CLS','E2级','C2级','SLC'];
...
function changeCity(){
	...
	cityList['E1级']=['长轴距E轿车', '长轴距E级运动轿车', '标准轴距E级车运动版', '梅赛德斯-AMG E 43 4MATIC', '全新梅赛德斯-AMG E 63 S 4MATIC+特别版'];
	cityList['C1级']=['长轴距C级运动轿车', '标准轴距C级车运动版', '长轴距C级轿车', '新一代C级旅行轿车', '新一代梅赛德斯-AMG C 43 4MATIC', '一代梅赛德斯-AMG C 63 4MATIC'];
	...
	cityList['E2级']=['E级轿跑车', '全新E级敞篷轿跑车'];
	cityList['C2级']=['新一代C级轿跑车', '新一代梅赛德斯-AMG C 43 4MATIC 轿跑车','新一代梅赛德斯-AMG C63 轿跑车'];
