...
<html>
	...
	<body>
		...
		<div >
			<img src="/Benz/img/promotion/banner_1000x295.jpg" width="100%"/>
		</div>
		<div style="position: relative; margin-top: -80px;margin-bottom: 0;margin-left:20%;padding: 80px 70px 40px 70px;background-color: #fff;z-index: 20;
			width: 900px; box-shadow: 0 0 10px 0 #aaa;">
			<h1>最新活动信息</h1>
			<br />
			<h4 style="line-height: 30px;">拥有一辆梅赛德斯-奔驰汽车，所包含的价值绝不仅仅在于汽车本身，更可拥有梅赛德斯-奔驰为您提供的贴心服务。
			我们关注客户需求，组织各类内容丰富、形式多样的售后活动。
			在您享受更优惠售后服务价格的同时，更帮助您更好地了解爱车的状态，使您安然悠享和爱车共度的美好时光。</h4>
		</div>
		<div style="padding-top: 50px;">
			<img src="/Benz/img/promotion/package_1440x400.jpg"width="100%" />
		</div>
		<div style="position: relative; margin-top: -80px;margin-bottom: 0;margin-left:20%;padding: 80px 70px 40px 70px;background-color: #fff;z-index: 20;
			width: 900px; box-shadow: 0 0 10px 0 #aaa;">
			<h1>懂你，才懂价值</h1>
			...
			<h4 style="line-height: 30px;">
				...
				懂，让我们离你更近<br /><br />
				价值，让你离美好的生活不远<br /><br />
				我们懂得越多 就能越好的为你创造价值<br /><br />
				这个夏天，我们懂你对生活的追求，经销商安排了丰富的活动等你来参与：<br /><br />
				7月，我们懂你对足球文化的热爱，为你提供自在、热烈的观赛体验。<br /><br />
				7月中旬-8月中旬，我们懂你对爱车保养的关切，为你解锁夏季出行安全知识；带你探索车间奥秘、感受梅赛德斯-奔驰专业化标准服务；同时还可以挑战车间任务，赢取奖励。<br /><br />
				8月，我们懂你对爱和浪漫的追求，为你打造专属浪漫七夕晚宴， 带上你的TA一起来感受浪漫之夜。<br /><br />
				懂你，才懂价值。<br /><br />
				活动详情敬请垂询当地授权经销商<br /><br />
			</h4>
		</div>
		<div style="padding-top: 50px;">
			<img src="/Benz/img/promotion/experience_1440x400.jpg"width="100%" />
		</div>
		<div style="position: relative; margin-top: -80px;margin-bottom: 0;margin-left:20%;padding: 80px 70px 40px 70px;background-color: #fff;z-index: 20;
			width: 900px; box-shadow: 0 0 10px 0 #aaa;">
			<h1>原厂核心部件延长保修套餐</h1>
			<br />
			<h4 style="line-height: 30px;">
				梅赛德斯-奔驰原厂修养套餐家族，致力于为您带来超越以往的升级服务体验。针对于座驾的发动机、变速箱、前/后桥三大关键部位，梅赛德斯-奔驰特为车龄在34个月以内的车主推出“梅赛德斯-奔驰 原厂核心部件延长保修套餐”，在享受原厂专业服务的同时，亦无需再支付意料不到的大额维修费用。<br /><br />

				小投入， 大保障<br /><br />
				
				一份微小的支出，即可规避意料不到的大额维修支出，在关键部位的延长保修，为您未雨绸缪，更为您的长远驾驶保驾护航。<br /><br />
				星徽品质，惠享关键保障<br /><br />
				先进的诊断设备、原厂配件（含原厂再制造配件）、标准化服务流程， 以及统一认证的专业维修服务团队，将为您爱车的核心部件提供充足的保护，在您前进的路上，都有安心相伴。<br /><br />
				原厂核心部件延长保修套餐目前已在全国授权经销商推出，购买详情可垂询当地授权经销商。<br /><br />
				足不出户购买原厂保养套餐，更有精美礼品相送<br /><br />
				关注“Mercedesme我的奔驰”微信公众号，点击进入梅赛德斯-奔驰电子商务平台。即日起至2018年7月31日，在该平台购买原厂保养套餐或原厂保养套餐轻享版，可获赠总价值为226元的 Mercedes me 城市系列精美旅行套装，限量300份，送完即止。<br /><br />
				
				
				锁定梅赛德斯-奔驰天猫旗舰店，买原厂延保套餐送保养套餐抵用券<br /><br />
				即日起至2018年7月31日，在天猫平台购买原厂整车延长保修套餐，将赠送价值500元保养类套餐抵用金，限量500份，先到先得。<br /><br />
			</h4>
		</div>
		<div class="p">
			<div>
